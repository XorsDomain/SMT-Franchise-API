using Shin.Megami.Tensei.API.Filters;
using System.Net.Mime;
using Shin.Megami.Tensei.Data;
using Shin.Megami.Tensei.Data.Context;
using Shin.Megami.Tensei.Providers;
...
namespace Shin.Megami.Tensei.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "Shin.Megami.Tensei.API", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, HealthCtx db)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(options => options.SwaggerEndpoint("/swagger/v1/swagger.json", "Shin.Megami.Tensei.API v1"));
            }
